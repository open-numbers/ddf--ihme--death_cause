...
def main():
    ...
    location = [10, 101, 102, 105, 106, 107, 108, 109, 11, 110, 111,
                ...
                38, 385, 39, 40, 41, 43, 435, 44, 45, 46, 47, 48, 49,
                50, 51, 52, 522, 53, 54, 55, 57, 58, 59, 6, 60, 61,
                62, 63, 66, 67, 68, 69, 7, 71, 72, 74, 75, 76, 77,
    ...
    age = [1, 23]  # TODO: make full list

    m.bulk_download('../source', version, context, year=year,
                    location=location, age=age, measure=measure,
                    metric=metric, sex=sex,
                    email="semio@tutanota.com")
